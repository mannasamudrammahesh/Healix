...
export default function Career() {
    ...
    const handleClick = (e) => {
        ...
        // Set the career description from conditionResponses
        setCareerDescription(conditionResponses[customValue] || "Information about this condition is currently unavailable.");
